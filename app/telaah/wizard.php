...
<div class="p-8 max-w-6xl mx-auto">
    ...
    <div class="text-center mb-10">
        <a href="/dashboard" class="text-slate-500 hover:text-blue-600 text-sm flex items-center justify-center font-medium mb-4">
        ...
        <div id="step-1" class="step-content">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                    ...
                    <input type="text" name="tahapan_pelaksanaan"
                           value="<?php echo htmlspecialchars($telaah['tahapan_pelaksanaan'] ?? ''); ?>"
                           class="w-full px-4 py-3 border border-slate-300 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-blue-500 outline-none"
...
function saveDraft() {
    ...
    .then(data => {
        if (data.success) {
            ...
            // Redirect ke list telaah
            setTimeout(() => {
                window.location.href = '/telaah/list';
            }, 1000);
        } else {
...
<?php include __DIR__.'/../partials/footer.php'; ?> stepper UI
    for (let i = 1; i <= 3; i++) {
