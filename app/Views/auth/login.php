    ...
    <div class="relative z-10 w-full max-w-4xl bg-white rounded-2xl shadow-2xl overflow-hidden flex flex-col md:flex-row m-4">
        ...
        <div class="w-full md:w-1/2 p-10 md:p-12 bg-white">
            ...
            <form method="post" action="/login" class="space-y-5">
                ...
                <div>
                    <label class="block text-xs font-bold text-slate-600 uppercase mb-2 tracking-wider">Username</label>
                    <div class="relative">
                        <span class="material-icons absolute left-3 top-3 text-slate-400 text-lg">person</span>
                        <input type="text" name="username" required class="w-full pl-10 pr-4 py-3 bg-slate-50 border border-slate-200 rounded-lg focus:bg-white focus:ring-2 focus:ring-blue-500/20 focus:border-blue-600 transition-all outline-none font-medium text-slate-800" placeholder="Username">
                    </div>
                </div>
