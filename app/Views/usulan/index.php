...
<div class="p-8 max-w-7xl mx-auto">
    <div class="flex justify-between items-center mb-8">
        <div>
            <h1 class="text-3xl font-extrabold text-slate-900 tracking-tight">Daftar Pengajuan Telaah</h1>
            ...
            <div class="bg-white rounded-2xl shadow-sm border border-slate-200 p-6 hover:shadow-md transition-all">
                ...
                <div class="grid grid-cols-2 md:grid-cols-4 gap-4 mb-4 pb-4 border-b border-slate-100">
                    ...
                    <div>
                        ...
                        <div class="text-sm font-bold text-slate-700"><?php echo date('d M Y H:i', strtotime($t['updated_at'])); ?></div>
                    </div>
                </div>
